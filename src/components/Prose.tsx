  ...
  return (
    <div
      className={cn(
        ...
        "[&_p]:mt-4 [&_ul]:mt-4 [&_ul]:space-y-2 [&_ul]:pl-5 [&_ul>li]:list-disc [&_li]:marker:text-ink-muted",
        "[&_ol]:mt-4 [&_ol]:space-y-2 [&_ol]:pl-5 [&_ol>li]:list-decimal",
        "[&_blockquote]:mt-4 [&_blockquote]:border-l-2 [&_blockquote]:border-brand-orange [&_blockquote]:pl-4 [&_blockquote]:italic",
